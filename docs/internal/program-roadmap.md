...
| D-11 | Remote; trunk-based, short-lived branches, PRs; CI substitutes for code review. Self-merge lapsed when the repo went public (FD-38) - merging is now a human decision | 2026-07-03 (amended 2026-07-31) | `EXECUTION.md` |
