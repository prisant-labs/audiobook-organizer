...
| v0.5.0 | acting | [spec](releases/v0.5.0-acting/spec.md) | [plan](releases/v0.5.0-acting/implementation-plan.md) | built (gate walked 2026-07-19; round-trip byte-identical on fixtures and real-data subset copies; merges queued on the Actions billing fix; AC-17 fuller-copy ratification + tag awaiting jp per D-10) | Rollback round-trip byte-identical on fixtures AND real-data copy | PRs #23, #24, #27, #28 |
