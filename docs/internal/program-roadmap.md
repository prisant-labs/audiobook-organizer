...
| v0.3.0 | planning | [spec](releases/v0.3.0-planning/spec.md) | [plan](releases/v0.3.0-planning/implementation-plan.md) | in progress (P1-P6 built and merged 2026-07-04/05: data model, templates, policies, rulesets, builder, validation, provenance, detection, duplicates; P7 exports + P8 HTML report remain) | Deterministic validated plan; HTML report passes non-engineer read test | PRs #14, #15 |
