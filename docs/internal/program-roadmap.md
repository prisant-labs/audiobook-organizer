...
| v0.4.0 | seeing | [spec](releases/v0.4.0-seeing/spec.md) | [plan](releases/v0.4.0-seeing/implementation-plan.md) | built locally (all 8 phases + 3 adversarial reviews done 2026-07-06; merges + CI green queued behind the Actions billing block; G-1 human review loop pending jp) | Human approves real-library plan in app; preview responsive over 718 folders | - |
